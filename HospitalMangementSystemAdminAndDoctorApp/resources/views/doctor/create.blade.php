    ...
    <div class="col-12 col-md-6 d-none " id="doctorInfo">
        <div class="card">
            ...
            <form class="card-body row" id="doctorForm" >
                ...
                <div class="form-group col-6">
                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Department</label>
                    <select class="form-control" required="" name="department_id" type="text" value = "Departement">
